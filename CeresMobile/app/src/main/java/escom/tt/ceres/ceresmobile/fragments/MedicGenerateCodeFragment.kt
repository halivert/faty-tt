...
import escom.tt.ceres.ceresmobile.activities.MedicMainActivity.Companion.idUser
import escom.tt.ceres.ceresmobile.activities.MedicMainActivity.Companion.medic
...
class MedicGenerateCodeFragment : Fragment() {
  ...
  private suspend fun generateMedicalCode(): String {
    val url = "$URL_MEDICO/$idUser/token/"
  ...
  override fun onResume() {
    super.onResume()
    view?.findViewById<EditText>(R.id.et_code)?.text?.clear()
  ...
  companion object {
    ...
    fun newInstance(): MedicGenerateCodeFragment {
      return MedicGenerateCodeFragment()
    }
  }
}
