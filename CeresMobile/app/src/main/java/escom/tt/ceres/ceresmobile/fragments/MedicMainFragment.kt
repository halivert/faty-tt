...
class MedicMainFragment : Fragment() {
  ...
  override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
    ...
    patientsNumber.text = MedicMainActivity.patients.size.toString()
  ...
  companion object {
    ...
    fun newInstance(idUser: Int): MedicMainFragment {
      val fragment = MedicMainFragment()
      val args = Bundle()
